...
package com.example.photopaint.views.actionbar;
...
//import com.example.photopaint.messenger.LocaleController;
import com.example.photopaint.R;
import com.example.photopaint.views.components.LayoutHelper;
import com.example.photopaint.views.components.LineProgressView;
import com.example.photopaint.views.components.RadialProgressView;
...
public class AlertDialog extends Dialog implements Drawable.Callback {
    ...
    public static class AlertDialogCell extends FrameLayout {
        ...
        public AlertDialogCell(Context context) {
            ...
            addView(imageView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, 40, Gravity.CENTER_VERTICAL | Gravity.LEFT));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (title != null) {
            ...
            titleContainer.addView(titleTextView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.LEFT | Gravity.TOP, 0, 19, 0, (subtitle != null ? 2 : (items != null ? 14 : 10))));
        }
        ...
        if (secondTitle != null && title != null) {
            ...
            secondTitleTextView.setGravity(Gravity.RIGHT | Gravity.TOP);
            titleContainer.addView(secondTitleTextView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.RIGHT | Gravity.TOP, 0, 21, 0, 0));
        }
        ...
        if (subtitle != null) {
            ...
            containerView.addView(subtitleTextView, LayoutHelper.createLinear(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.LEFT | Gravity.TOP, 24, 0, 24, items != null ? 14 : 10));
        }
        ...
        messageTextView.setGravity(Gravity.LEFT | Gravity.TOP);
        if (progressViewStyle == 1) {
            ...
            progressViewContainer.addView(progressView, LayoutHelper.createFrame(44, 44, Gravity.LEFT | Gravity.TOP));

            messageTextView.setLines(1);
            messageTextView.setEllipsize(TextUtils.TruncateAt.END);
            progressViewContainer.addView(messageTextView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.LEFT | Gravity.CENTER_VERTICAL, 62, 0, 0, 0));
        } else if (progressViewStyle == 2) {
            containerView.addView(messageTextView, LayoutHelper.createLinear(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.LEFT | Gravity.TOP, 24, title == null ? 19 : 0, 24, 20));
            ...
            lineProgressViewPercent.setGravity(Gravity.LEFT | Gravity.TOP);
            ...
            containerView.addView(lineProgressViewPercent, LayoutHelper.createLinear(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.LEFT | Gravity.TOP, 23, 4, 23, 24));
            ...
            scrollContainer.addView(messageTextView, LayoutHelper.createLinear(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.LEFT | Gravity.TOP, 24, 0, 24, customView != null || items != null ? customViewOffset : 0));
        }
...
//                textView.setSingleLine(true); //TODO
    ...
    private void showCancelAlert() {
        ...
        builder.setMessage("StopLoading");
        builder.setPositiveButton("WaitMore", null);
        builder.setNegativeButton("Stop", new OnClickListener() {
            @Override
